...
// --- WHATSAPP CONTACT ENGINE ---
const initWhatsAppContact = () => {
    ...
    contactForm.addEventListener('submit', (e) => {
        ...
        const message = contactForm.querySelector('#msg').value;

        // Aapka updated number
        const myNumber = "919813455636"; 

        // Message ko format karna (Bold headings ke saath)
        ...
        // Form reset karna optionally
        contactForm.reset();
    });
};

// Ise initialization mein call karein
document.addEventListener('DOMContentLoaded', () => {
    initWhatsAppContact();
    // Baki ke init functions yahan rahenge...
});